import { Box, measureElement, Newline, Text } from "ink";
...
function BrailleImage(props) {
    ...
    const { onSupportDetected, src, width: propsWidth, height: propsHeight, allowPartial, } = props;
    ...
    return (React.createElement(Box, { ref: containerRef, flexDirection: "column", flexGrow: 1 }, imageOutput ? (imageOutput.split("\n").map((line) => React.createElement(Text, { key: line }, line))) : (React.createElement(Box, { flexDirection: "column", alignItems: "center", justifyContent: "center" },
