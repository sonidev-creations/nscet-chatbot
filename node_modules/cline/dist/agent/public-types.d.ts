 ...
 */
export type SessionUpdatePayload<T extends SessionUpdateType> = Omit<Extract<acp.SessionUpdate, {
    sessionUpdate: T;
}>, "sessionUpdate">;
/**
 ...
 */
export declare enum AcpSessionStatus {
